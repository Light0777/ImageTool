...
const ImageExample = () => {
    return (
        <div className='w-full md:w-100 grid justify-center items-center'>
            {/* Image Container */}
            <div className="relative w-full h-68 md:h-56 lg:h-64 xl:h-70 overflow-hidden rounded-3xl md:rounded-4xl grid justify-center items-center mx-auto">
                <Image
            ...
            <div className='py-4 sm:py-5 mt-2'>
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black tracking-tight text-center md:text-left w-100">
