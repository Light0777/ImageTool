...
//                       className={`shrink-0 w-16 h-16 rounded-lg overflow-hidden border-2 transition-all ${index === currentImageIndex ? 'border-white scale-110' : 'border-gray-600 hover:border-gray-400'}`}
//                     >
...
// app/page.tsx - Updated with better file transfer
'use client';
    ...
    <main className="h-auto bg-white text-black px-4 md:px-8 font-sans">
      <div className="w-full mx-auto">
        {showConversion ? (
          ...
          <>
            {/* Mobile Header */}
            <header className="mb-8 block md:hidden text-center">
              
            </header>

            {/* Desktop Header (hidden on mobile) */}
            <header className="mb-12 text-center hidden md:block">
            ...
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="block md:hidden w-full max-w-md mx-auto space-y-8">
                <ImageExample />
                <UploadZone
              ...
              <div className="hidden md:flex justify-between items-center w-full">
                <div className="w-1/2 flex justify-end pr-4 lg:pr-8">
                  <ImageExample />
                </div>
                <div className="w-1/2 flex justify-start pl-4 lg:pl-8">
                  <UploadZone
                    onFilesSelect={handleFilesSelect}
                    fileInputRef={fileInputRef}
                    maxFiles={10}
